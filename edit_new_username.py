...
frame.pack()
labelframe = LabelFrame(root, text="Edit Username",bd=2,fg="navy",font=("italic",45,"bold"),bg="gainsboro",highlightthickness=15)
...
Button(labelframe, text='Change',width=13,font=("courier",12,"bold"),bg='navy',fg='white',bd=5).place(x=105,y=280)

...
frame.pack()
b1=Button(root, text='Add User',width=36,height=2,font=("bold",50),bd=10,bg='navy',fg='white',relief=RAISED).place(x=50,y=260)
#Button(root, text='Delete User',width=10,height=2,font=("bold",50),bd=10,bg='navy',fg='white',relief=RAISED).place(x=560,y=260)
#Button(root, text='Change Role',width=10,height=2,bd=10,font=("bold",50),bg='navy',fg='white',relief=RAISED).place(x=1070,y=260)
Button(root, text='Search by Username',width=17,height=2,bd=10,font=("bold",50),bg='navy',fg='white',relief=RAISED).place(x=50,y=550)
Button(root, text='List of Users',width=17,height=2,bd=10,font=("bold",50),bg='navy',fg='white',relief=RAISED).place(x=800,y=550)
root.mainloop()

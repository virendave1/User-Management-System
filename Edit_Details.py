...
frame.pack()
labelframe = LabelFrame(root, text="Edit Detils",bd=2,fg="navy",font=("italic",45,"bold"),bg="gainsboro",highlightthickness=15)
labelframe.pack(fill="both",expand="yes")
Button(labelframe, text='Name',width=20,bd=7,font=("courier",20,"bold"),bg='navy',fg='white',relief=RAISED).place(x=90,y=50)
Button(labelframe, text='Username',width=20,bd=7,font=("courier",20,"bold"),bg='navy',fg='white',relief=RAISED).place(x=90,y=170)
Button(labelframe, text='Email',width=20,bd=7,font=("courier",20,"bold"),bg='navy',fg='white',relief=RAISED).place(x=90,y=270)
Button(labelframe, text='Password',width=20,bd=7,font=("courier",20,"bold"),bg='navy',fg='white',relief=RAISED).place(x=90,y=370)

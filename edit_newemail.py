...
frame.pack()
labelframe = LabelFrame(root, text="Edit Email",bd=2,fg="navy",font=("italic",45,"bold"),bg="gainsboro",highlightthickness=15)
labelframe.pack(fill="both",expand="yes")
label_uname = Label(labelframe, text="Enter New Email-ID:",font=("courier", 20,"bold"),fg="navy",bg="gainsboro")
label_uname.place(x=45,y=50)
entry_uname = Entry(labelframe,width=45,bd=5,bg="white",fg="navy")
entry_uname.place(x=50,y=130)
label_uname = Label(labelframe, text="Enter OTP:",font=("courier", 20,"bold"),fg="navy",bg="gainsboro")
label_uname.place(x=45,y=200)
entry_uname = Entry(labelframe,width=45,bd=5,bg="white",fg="navy")
entry_uname.place(x=45,y=280)
Button(labelframe, text='Change',width=13,font=("courier",12,"bold"),bg='navy',fg='white',bd=5).place(x=105,y=380)
